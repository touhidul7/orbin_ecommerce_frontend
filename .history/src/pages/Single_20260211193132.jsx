 ...
 *
 * ✅ Fix:
 * - Your API returns { "0": [ ... ] }, not result[0]
 */
...
function upsertCartItem(cart, product, qtyToAdd = 1) {
  ...
  if (idx >= 0) {
    // if you DON'T want to increase qty when re-checking, replace with: quantity: 1
...
const Single = () => {
  ...
  const recommendedList = useMemo(() => {
    ...
    // exclude current item and items already in cart
