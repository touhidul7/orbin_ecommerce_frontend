...
import { doSignInWithPhoneAndPassword } from '../firebase/auth';
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = await doSignInWithPhoneAndPassword(phone, password);
                                    ...
                                    <div className="space-y-5">
                                        <div>
                                            ...
                                            <div className="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                                ...
                                                <input
                                                    type="text"
                                                    name="phone"
                                                    placeholder="Enter phone to get started"
                                        ...
                                        <div>
                                            <button
                                                ...
                                                className={`inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#DF263A] ${
                                                    isSigningIn
                                                        ? 'opacity-70 cursor-not-allowed bg-[#DF263A]'
                                                        : 'bg-[#DF263A] hover:bg-[#8f0000]'
                                                }`}
                                            >
