...
//         <>
//             <Header />
//             <section class="py-10 bg-gray-50 sm:py-16 lg:py-24 mt-10">
//                 {userLoggedIn && (<Navigate to={"/"} replace={true} />)}
//                 <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
//                     <div class="max-w-2xl mx-auto text-center">
//                         <h2 class="text-2xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Register  Here!</h2>
//                     </div>

//                     <div class="relative max-w-md mx-auto mt-4 md:mt-16">
...
//                                         <div>
//                                             <button
//                                                 type="submit" class="cursor-pointer inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-[#AD0101] border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">
//                                                 Register
//                                             </button>
//                                         </div>

//                                         <div class="text-center">
//                                             <p class="text-base text-gray-600">Have an account? <Link to="/login" title="" class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Login your account</Link></p>
//                                         </div>
//                                     </div>
//                                 </form>
//                             </div>
                    ...
                    <div className="relative max-w-md mx-auto mt-3 mb-8 sm:mt-12 lg:mt-16">
                        <div className="overflow-hidden bg-white rounded-md shadow-md">
                          ...
                          ${isSigningUp
                                                        ...
                                                        : 'bg-[#AD0101] hover:bg-red-700 active:bg-red-800'}
                        `}
                                            >
